...
public class Mascota {
    ...
    public Mascota(int num_cliente, String nombre_perro, String raza, String color, boolean alergico, boolean atencion_especial, String observaciones, Duenio due) {
